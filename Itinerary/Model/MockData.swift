...
class MockData{
    ...
    static func createmockDayModelData() -> [DayModel] {
        ...
        dayModels.append(DayModel(title: Date().add(days: 1), subtitle: "Volunteering", data: createMockActivityModelData(sectionTitle: "April 21")))
        dayModels.append(DayModel(title: Date().add(days: 1), subtitle: "Time to go back home", data: createMockActivityModelData(sectionTitle: "April 22")))
